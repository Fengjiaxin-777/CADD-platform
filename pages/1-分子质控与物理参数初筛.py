...
# 统一注入样式并针对原生 border 容器重写样式以覆盖原 card 风格
st.markdown(""" 
<style>
    ...
    /* 强力重定向 Streamlit 原生 border 容器的边框以平替原先的 .card */
